...
ALTER TABLE "InvoiceItems" ADD FOREIGN KEY ("item_id") REFERENCES "InventoryItems" ("id");

ALTER TABLE "InventoryTransactions" ADD FOREIGN KEY ("item_id") REFERENCES "InventoryItems" ("id");
