...
public class ServerMain {
        public static void main(String[] args) throws Exception {
                ...
                InventoryController.mount(router); // Mount Inventory API
                StockMovementController.mount(router); // Mount Stock Movement API
                AlertController.mount(router); // Mount Alert API
